package com.example.splashandregist // Sesuaikan package kamu
...
object SupabaseClient {
    ...
    // 👇 GANTI DENGAN PUNYA KELOMPOK KALIAN (Copy dari Website Supabase)
    ...
    val client = createSupabaseClient(
        ...
        install(Auth)      // Buat Login
        install(Postgrest) // Buat Database (CRUD)
        install(Storage)   // Buat Upload Gambar
    }
}